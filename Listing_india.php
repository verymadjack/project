...
<body class="landing is-preload">
		...
		<!-- Page Wrapper -->
			<div id="page-wrapper">
				...
				<!-- Main -->
					<article id="main">
						<header style="background-image: url('images/india.jpg');">
							<h2>India</h2>
							<p>Palaces & Deserts of Rajasthan</p>
						</header>
						<section class="wrapper style5">
							<div class="inner">
							<section>
							<h5>Jacek Siwicki</h5>
									<blockquote>An incredible journey through the desert province of Rajasthan, including Delhi, Jaipur, Jodhpur, the Taj Mahal and much more!</blockquote>
							<h4>Perks</h4>
									<div class="row">
									...
									<form method="post" action="#">
										<div class="row gtr-uniform">
											...
											<div class="col-6 col-12-xsmall">
												<input type="text" name="demo-email" id="demo-email" value="" placeholder="Surname" />
											</div>
											<div class="col-6 col-12-xsmall">
												<input type="email" name="demo-email" id="demo-email" value="" placeholder="Email" />
											</div>											
											<div class="col-6 col-12-xsmall">
												<input type="date" name="trip-start" id="demo-email" value="2022-09-21" min="2022-12-12" max="2025-12-31" placeholder="Departure Date" />
											</div>
											<div class="col-12">
											...
											<div class="col-12">
												<textarea name="demo-message" id="demo-message" placeholder="Enter your message regarding the trip and we will take it to consideration" rows="6"></textarea>
											</div>
											<div class="col-12">
												<ul class="actions">
